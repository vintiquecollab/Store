...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center">
      {/* Left Navbar */}
      <div className="text-6xl mx-12 cursor-pointer" onClick={() => navigate("/")}>
        <img src=".\src\images\vintique.png" alt="logo" className="w-[150px] h-[150px]" />
      </div>
      {/* Right Navbar */}
      <div className="flex items-center gap-8 mx-12">
        <div className="flex items-center border p-3 rounded-full bg-gray-100">
          <input className="bg-gray-100 outline-none px-3" type="text" placeholder="Search" />
        ...
        {isLoggedIn && user ? (
          <div className="relative">
            <div onClick={handleDropdownToggle} className="flex items-center cursor-pointer">
              ...
              <img src={user.image.url} alt="avatar" className="w-8 h-8 rounded-full ml-2" />
            </div>
            {dropdownOpen && (
